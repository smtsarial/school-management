                    ...
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            <a href="javascript:void(0)" class="u-dropdown link hide-menu" role="button"
                                aria-haspopup="true" aria-expanded="false">Erdal Yaprak</a>
                        </div>
                    </div>
                </div>
                <!-- Sidebar navigation-->
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="../instructor-pages/Research-group-page.php">Research Group
                                        Informations</a></li>
                                <li><a href="../instructor-pages/Approve-Reject Groups.php">Approve/Reject Groups</a>
                                </li>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button type="button"
                                                        onclick="alert('Successfully added')">Approve</button></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>xxxxxxxxxx</td>
                                                <td>Name22 Surname22</td>
                                                <td>Web Programming 1</td>
                                                <td>Group 2</td>
                                                <td>
                                                    <button type="button"
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>xxxxxxxxxx</td>
                                                <td>Name23 Surname23</td>
                                                <td>Web Programming 3</td>
                                                <td>Group 1</td>
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"
