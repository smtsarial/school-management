                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if (isset($_POST['addcourse'])) {
                                    ...
                                    $sql = "INSERT INTO courses (course_name, course_description, instructor_id, secretary_id, type, day, start_time, stop_time) VALUES ('$course_name ','$course_description ','$instructor_id' ,' $user_id','$day ',' $styled_radio ',' $start_time  ', '$stop_time ');";
                                ...
                                <form method="post" class="form-horizontal form-material" id="addcourse" action="create-delete-course.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label" for="styled_radio1" style="color:black">Mandatory</label>
                                            </div>

                                            <div class="custom-control custom-radio">
                                                <input type="radio" value="Elective" name="styled_radio" id="styled_radio2" class="custom-control-input" name="type">
                                                <label class="custom-control-label" for="styled_radio2" style="color:black">Elective</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                ...
                                                <select id="day" name="day">
                                                    ...
                                                    <option value="Tueasday">Tuesday</option>
                                    ...
                                    <div class="form-group text-center p-b-20">
                                        <div class="col-xs-12">
                                            <button class="btn btn-block btn-lg btn-info btn-rounded" type="submit" name="addcourse">Add Course</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
